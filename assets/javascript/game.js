...
function Hangman() {
    this.wordList = ["bass", "guitar", "bassoon", "cello", "clarinet", "cymbal", "drums", "flute", "harmonica", "mandolin", "oboe", "organ", "piano", "piccolo", "recorder", "saxophone", "tambourine", "triangle", "trombone", "trumpet", "tuba", "ukulele", "viola", "violin", "xylophone"]
